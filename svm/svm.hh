...
public:
  enum IType { 
    IPUSH=0, IPOP, IDUP, ISWAP, IADD, ISUB, IMUL, IDIV,
    IGOTO, IEQ, IGT, IGE, ILT, ILE, 
    ISKIP, ISTORE, ILOAD, IPRINT, IJMPZ, IJMPN, 
    IAND, IOR, INEG, INOT , IHALT, ICALL, IMARK, ISTORER, ILOADR, 
    IPUSHA, IENTER, IALLOC, IRETURN
  };
